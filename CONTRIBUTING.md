# Contributing to cdadityang Website

## Before Submitting an Issue
Check that [our issue database](https://github.com/cdadityang/my-website/issues)
...
2. Install the app on your local machine. You need to [Fork](https://help.github.com/articles/fork-a-repo/) this app and then clone it on your local machine. See the Installation section of [README.md](https://github.com/cdadityang/my-website/blob/master/README.md) on how to do the installation.

3. Set the upstream remote so you can keep your copy of the app synced with the original. To do that, go to your terminal and cd into your cloned cdadityang `my-website` app directory. Then use one of the following commands:
    * If you have ssh set up with Git
      ```bash
      $ git remote add upstream https://github.com/cdadityang/my-website.git
      ```
      Or
      ```bash
      git remote add upstream git@github.com:cdadityang/my-website.git
      ```
...
5. When you have finished and are ready to submit a Pull Request:
    * Push your branch to your fork
      ...
      ```
    * Go to your fork on Github after you have pushed up your branch. A new button should be visible near the top of the page. It will allow you to create a pull request to the original cdadityang `my-website` repo.
